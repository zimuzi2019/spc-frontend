...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const spcChartXMedium = echarts.init(document.getElementById("spcChartXMedium"))
      spcChartXMedium.setOption({
        legend: {
          data: ['中位数'],
          orient: 'horizontal',
          left: 'center',
        ...
        series: [
          {
            name: '中位数',
            data: graphData.value.dataArrayXMedium,
            type: 'line',
            itemStyle: {
              color: (params) => {
                if (params.value > graphData.value.uclXMedium) return '#ff6347'
                else if (params.value < graphData.value.lclXMedium) return '#ff00ff'
                else return '#ADD8E6'
              }
            },
            lineStyle: {
            ...
            markLine: {
              ...
              data: [
                {
                  name: 'UCL',
                  yAxis: graphData.value.uclXMedium,
                  lineStyle: {
                    color: '#ff6347',
                    width: 2,
                  },
                ...
                {
                  name: 'CL',
                  yAxis: graphData.value.clXMedium,
                  lineStyle: {
                    color: '#0000ff',
                    width: 2,
                  },
                ...
                {
                  name: 'LCL',
                  yAxis: graphData.value.lclXMedium,
                  lineStyle: {
                    color: '#ff00ff',
                    width: 2,
                  },
